...
##################################
PROJECT_NAME: str = "ItalianSigns"
PROJECT_NAME_FULL: str = "ItalianSigns"
...
HOMEPAGE_URL: str = "https://www.kaggle.com/datasets/officialprojecto/italiansigns"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 6819629
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/italian-signs"
...
AUTHORS_CONTACTS: Optional[List[str]] = ["daniel.rossi@unimore.it", "riccardo.salami@unimore.it"]
